...
/* -----------------------------------------------
	encoder/decoder tweaks
	----------------------------------------------- */

// sacrifice a few byte to drastically reduce memory consumption
// WARNING: changing will lead to incompatibilities
